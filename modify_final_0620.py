...
class BulkTransCrypto:
    ...
    def make_result_csv(self):
        ...
        with open("result.csv","w", newline='') as csv_file:
            ...
            csv_writer.writerow(['bnb_wallet', 'sum_bnb','id','Transaction_ID'])
            
            for _item in self.tx_list:
                if _item['wrong_wallet']:
                    continue
                csv_writer.writerow([_item['bnb_wallet'],_item['sum_bnb'],_item['id'],_item['transaction_id']])
    ...
    def send_crypto(self, _src_addrs, _dest_addrs, _amount):
        ...
        #print(type('Payment ID:',_payments.id))
